...
public class ComplexityClassificationBaseline
    implements Constants
{
        ...
        throws Exception
    {
    	...
    	System.setProperty("DKPRO_HOME", "src/main/resources/output/ComplexityExperiment-Majority/" + timestamp);
        ...
        throws Exception
    {
    	...
    	ExperimentCrossValidation batch = new ExperimentCrossValidation("ComplexityExperiment-Majority",
